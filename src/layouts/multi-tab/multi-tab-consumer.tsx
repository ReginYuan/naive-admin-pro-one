...
export const MultiTabConsumer = defineComponent({
  ...
  setup(props, { slots }) {
    ...
    return () => {
      ...
      if (route.meta.keepAlive === false && isReactive(currentItem)) exclude.push(currentItem.key!)
      ...
      if (exclude.find(k => k === currentItem?.key)) delete componentCache[currentItem.key!]
